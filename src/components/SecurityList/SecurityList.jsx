...
import UpdateSecurityModal from "../UpdateModal/UpdateSecurityModal";
    ...
    <div className="ps-3 pe-3 pt-3">
      ...
      {isLoading ? (
        ...
        <Table responsive className="table table-striped table-primary w-auto">
          ...
          <tbody className="text-wrap">
            {paginate(securities, currentPage, itemsPerPage).map((policy) => (
                    ...
                    {isDeployLoader && policyId === policy.policy_id ? (
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          deployPolicyFile(policy.policy_id);
                        }}
                      >
                        Deploy
                      </button>
        ...
        <Pagination className="mt-3">
            {Array.from({ length: Math.ceil(securities.length / itemsPerPage) }).map(
              (_, index) => (
                <Pagination.Item
                  key={index}
      ...
      {showModal && securityDetails && (
        <UpdateSecurityModal
          ...
          updateSecurityMsg={updateSecurityMsg}
