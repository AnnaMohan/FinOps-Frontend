...
const UpdateSecurityModal = ({
  ...
  const [units, setUnits] = useState(
    securityDetails?.schedule?.schedule_value?.unit
    
  );
  const [unitValue, setUnitValue] = useState(
    securityDetails?.schedule?.schedule_value?.value
  );

  const [email, setEmail] = useState(
    securityDetails?.notificationDetails?.Emails
  );
  const save = () => {
    updatePolicyFile(
      policyId,
      email,
      securityDetails?.schedule?.schedule_type,
      units,
      unitValue
    );
  };
                ...
                <div className="form-group">
                  <div className="row">
                    <div className="modal-pb fw-bold">
                      Schedule Type : {securityDetails?.schedule?.schedule_type}
                    </div>
...
export default UpdateSecurityModal;
