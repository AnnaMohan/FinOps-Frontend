...
const UpdateReliabilityModal = ({
  ...
  const [units, setUnits] = useState(
    reliabilityDetails?.schedule?.schedule_value?.unit
    
  );
  const [unitValue, setUnitValue] = useState(
    reliabilityDetails?.schedule?.schedule_value?.value
  );

  const [email, setEmail] = useState(
    reliabilityDetails?.notificationDetails?.Emails
  );
  const save = () => {
    updateReliabilityPolicyFile(
      policyId,
      email,
      reliabilityDetails?.schedule?.schedule_type,
      units,
      unitValue
    );
  };
                ...
                <div className="form-group">
                  <div className="row">
                    <div className="modal-pb fw-bold">
                      Schedule Type : {reliabilityDetails?.schedule?.schedule_type}
                    </div>
...
export default UpdateReliabilityModal;
