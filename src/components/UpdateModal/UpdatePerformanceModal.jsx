...
const UpdatePerformanceModal = ({
  ...
  const [units, setUnits] = useState(
    performanceDetails?.schedule?.schedule_value?.unit
    
  );
  const [unitValue, setUnitValue] = useState(
    performanceDetails?.schedule?.schedule_value?.value
  );

  const [email, setEmail] = useState(
    performanceDetails?.notificationDetails?.Emails
  );
  const save = () => {
    updatePerformancePolicyFile(
      policyId,
      email,
      performanceDetails?.schedule?.schedule_type,
      units,
      unitValue
    );
  };
                ...
                <div className="form-group">
                  <div className="row">
                    <div className="modal-pb fw-bold">
                      Schedule Type : {performanceDetails?.schedule?.schedule_type}
                    </div>
