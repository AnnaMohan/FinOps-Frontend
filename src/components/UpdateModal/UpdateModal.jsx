...
const UpdateModal = ({
  ...
  const [units, setUnits] = useState(
    policyDetails?.schedule?.schedule_value?.unit
    
  );
  const [unitValue, setUnitValue] = useState(
    policyDetails?.schedule?.schedule_value?.value
  );

  const [email, setEmail] = useState(
    policyDetails?.notificationDetails?.Emails
  );
  const save = () => {
    updatePolicy(
      policyId,
      email,
      policyDetails?.schedule?.schedule_type,
      units,
      unitValue
    );
  };
                ...
                <div className="form-group">
                  <div className="row">
                    <div className="modal-pb fw-bold">
                      Schedule Type : {policyDetails?.schedule?.schedule_type}
                    </div>
